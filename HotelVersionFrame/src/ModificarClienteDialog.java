...
public class ModificarClienteDialog extends JDialog {
	...
	public ModificarClienteDialog(Hotel hotel) {
	...
	private class PulsarAceptar implements ActionListener {// Comportamiento al pulsar el boton Aceptar
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (!matcherDni.find()) {
				JOptionPane.showMessageDialog(ModificarClienteDialog.this,
			...
			if (dni.isEmpty() || nombre.isEmpty() || fecha.isEmpty() || numHabitacion.isEmpty()) {
				JOptionPane.showMessageDialog(ModificarClienteDialog.this, "Por favor, complete todos los campos.",
				...
				if(dniCorrecto && nombreCorrecto && fechaCorrecta && habitacionCorrecta) {
					...
					hotel.modificarDatosCliente(dni, cliente);
					// System.out.println("Se ha añadido con exito");
					JOptionPane.showMessageDialog(ModificarClienteDialog.this, "Se han realizado con exito los cambios");
