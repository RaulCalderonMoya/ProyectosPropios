...
public class MostrarDatosDeUno extends JDialog{
	...
	public MostrarDatosDeUno(Hotel hotel) {
		this.hotel = hotel;
		dniCorrecto = false;
	...
	private class PulsarAceptar implements ActionListener {// Comportamiento al pulsar el boton Aceptar
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (!matcherDni.find()) {
				JOptionPane.showMessageDialog(MostrarDatosDeUno.this,
			...
			if (dni.isEmpty()) {
				JOptionPane.showMessageDialog(MostrarDatosDeUno.this, "Por favor, complete todos los campos.",
