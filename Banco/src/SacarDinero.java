...
public class SacarDinero extends JDialog {
	...
	public SacarDinero(List<Cliente> listadoClientes) {
		setTitle("Sacar Dinero a un cliente");
		setLayout(new GridLayout(2, 1));

		labelDni = new JLabel("Introduzca el valor del DNI: ");
		textDni = new JTextField();
		labelDinero = new JLabel("Introduzca el valor de la cantidad a sacar");
		...
		public void actionPerformed(ActionEvent e) {
	        ...
	        while (iterator.hasNext()) {
	            ...
	            if (c.getDni().equalsIgnoreCase(clienteRef.getDni())) {
	            	...
	            	String dineroAExtraer =  textDinero.getText();//Obtengo el diero que el cliente desea ingresar
	            	double dinero = Double.parseDouble(dineroAExtraer);
	            	c.retirarDineroCliente(dinero);       	
